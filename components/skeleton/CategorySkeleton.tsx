...
export const CategorySkeleton = ({ categoryName = "Category" }: CategorySkeletonProps) => {
    return (
        <section className="py-12 md:py-16 lg:py-20 bg-white">
            <div className="container mx-auto max-w-[1660px] px-4 sm:px-6 lg:px-8">
                {/* Hero Skeleton */}
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gray-200 animate-pulse mb-6">
                    ...
                    <div className="h-5 w-2/3 bg-gray-200 rounded animate-pulse mx-auto mb-8" />
