...
const AboutComponent = () => {
  const stats = [
    { value: "500K+", label: "Monthly Readers", icon: Eye },
    { value: "24/7", label: "24/7 Live Support", icon: Phone },
    { value: "1000+", label: "industry experts", icon: Users },
    { value: "98%", label: "accuracy ratings", icon: Heart },
  ];
  ...
  const values = [
    {
      ...
      description:
        "We offer 100% accurate info, and our content is verified",
      color: "blue",
    },
    {
      icon: Target,
      ...
      description:
        "We think that knowledge is the best tool for freedom",
      color: "black",
    },
    {
      icon: TrendingUp,
      title: "Adaptability",
      description:
        "The world is going fast, and we embrace change and regularly update our views",
      color: "blue",
    },
    {
      icon: Globe,
      ...
      description:
        "Our main goal is to offer the best content to readers and value diverse perspectives",
      color: "black",
    },
  ];
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-br from-white via-blue-50 to-white overflow-hidden">
        ...
        <div className="relative container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
           Welcome to The World Daily Blog, a fantastic online place to find your way around the fun and complicated world of 2026. We are a team of authors, academic researchers, and industry specialists who want to turn the huge amount of daily information into clear, useful ideas. We are your reliable source for staying up to date and ahead of the curve in a time when technology is changing quickly, from the use of technology in daily life to the release of next-generation gaming consoles.
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="relative container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            Our goal is to give a global community of curious minds, from young workers to experienced scholars, the tools they need to make life easier by giving them superior, research-based material. We want to be the link between complicated data and everyday use, enabling you to take control of your money, build your business, and enjoy most of what modern entertainment has to offer.
