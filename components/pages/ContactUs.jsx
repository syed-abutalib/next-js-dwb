...
const ContactUs = () => {
  ...
  const departments = [
    ...
    
    {
      ...
      description: "312 W 2nd St A9493 Casper, WY 82601 USA",
    },
  ];
      ...
      <section className="relative py-20 md:py-28 bg-gradient-to-br from-white via-blue-50 to-white">
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
        Please contact us with any Nintendo Switch 2 library questions, 2026 new games, or 50/30/20 budgeting success stories.
            </motion.p>
          </motion.div>
        </div>
      </section>
